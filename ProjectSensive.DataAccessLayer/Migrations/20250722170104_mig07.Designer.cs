...
namespace ProjectSensive.DataAccessLayer.Migrations
{
    ...
    [Migration("20250722170104_mig07")]
    partial class mig07
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProjectSensive.EntityLayer.Concrete.AppRole", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("ProjectSensive.EntityLayer.Concrete.AppRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("ProjectSensive.EntityLayer.Concrete.AppUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ProjectSensive.EntityLayer.Concrete.Comment", b =>
                {
                    ...
                    b.HasOne("ProjectSensive.EntityLayer.Concrete.Article", "Article")
                        .WithMany("Comments")
